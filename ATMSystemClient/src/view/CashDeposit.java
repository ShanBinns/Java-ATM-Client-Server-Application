/**
 * This class displays the GUI for customer cash deposits
 * @author SBINNS
 *
 */
package view;
...
public class CashDeposit extends JFrame implements ActionListener{
	...
	public void initializeComponents() {
		...
		lblWelcome = new JLabel("PLEASE ENTER THE DESIRED DEPOSIT AMOUNT");
	...
	public void registerListeners()
	{
		...
		this.btnDepositCash.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(btnDepositCash) || e.getSource().equals(btnEnter))        
		{
			if((areaAmount.getText().equals(""))) {
				JOptionPane.showMessageDialog(null, "Please enter the amount to deposit", "Mtabank", JOptionPane.INFORMATION_MESSAGE);
			}else {
